...
import { Users, UserPlus, Mail, Phone, Loader2, X } from 'lucide-react';
import { usePeople, useCreatePerson } from '@/lib/queries';
    ...
    <div className="space-y-8">
      ...
      {people.length === 0 ? (
        <Card variant="linen" className="text-center py-16">
          ...
          <h3 className="text-base font-bold text-ink">No contacts added yet</h3>
          <p className="text-xs text-ink/60 mt-1 max-w-sm mx-auto mb-4">
            Contacts you add here will be available whenever you attach lent money or record debts.
          </p>
